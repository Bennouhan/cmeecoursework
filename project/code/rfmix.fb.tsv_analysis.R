...
nsamples <- read.table('RFMix2/output/RFMix2_output_chr22.fb.tsv')
# takes a minute to load, dim = 57397x3424
...
#NB: something like this may be handy to join them together?
...
pdf("../results/rfmix_boxplots.pdf", 6, 15)
