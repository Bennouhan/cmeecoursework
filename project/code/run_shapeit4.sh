...
##### Skipping straight to code, no nested script
...
--reference ../data/reference/shapeit4/CCDG_14151_B01_GRM_WGS_2020-08-05_chr${PBS_ARRAY_INDEX}.filtered.shapeit2-duohmm-phased_header.vcf.gz \
--thread 16 #number of ncpus!!
