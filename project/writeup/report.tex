...
% assortative mating index of zero suggests no assortative mating; positive is positive assortative mating; negative is negative. Would expect a distribution around zero with such a large sample size. ALL lower quartile ranges were above 0, and all but ASW and ACB had means at least one SD away from 0.
...
\begin{figure}[htb!]%%%%%%%%%%% ANCESTRAL AMIs
    \centering
    \includegraphics[height=0.93\textheight]{../results/anc_AMI_plot.png} 
    \vspace{.2cm}
    \caption{\textbf{
...
% From AMI plot, try to talk a bit about HWE as quality control being bad
% Also for AMI plot,  get reference saying HWE is reached in 2 or so generations, which shows the AMI plot does a decent job of deviating.

% refer to RFMIX vs ADMIXTURE plot here unless have in results already. saying one over-estimates blah blah blah or the other underestimates blah
...
\begin{figure}[!htb]%%%%%%%%%%% AMI Wilcoxin *3
\sffamily
\begin{tabular}{cc}
