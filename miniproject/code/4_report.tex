...
%NB: ctrl+alt+B to preview pdf and have it make the changes in real time (may require save)
\usepackage{graphicx}
...
\setcounter{section}{3} % use \% to write %. This sets section counter; probs dont need here!
\section{Results}
